...
We can now (finally) install Ruby! We recommend using the latest version, which is currently 2.7.1:
...
You can double check that this worked by typing `ruby -v` and checking that the output says version 2.7.1:

~~~bash
$ ruby -v
ruby 2.7.1pxx (20xx-xx-xx revision xxxxx)
~~~
